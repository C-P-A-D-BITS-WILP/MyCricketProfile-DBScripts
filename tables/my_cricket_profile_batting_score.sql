...
CREATE TABLE `batting_score` (
  ...
  `batting_score` int DEFAULT NULL,
  `sixers` int DEFAULT NULL,
  `dismissial_fk` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `innings_idx` (`innings_fk`),
  KEY `player_idx` (`player_fk`),
  KEY `dismissial_idx` (`dismissial_fk`),
  CONSTRAINT `dismissial` FOREIGN KEY (`dismissial_fk`) REFERENCES `dismissial` (`id`),
