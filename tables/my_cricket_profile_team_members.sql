...
CREATE TABLE `team_members` (
  ...
  PRIMARY KEY (`id`),
  KEY `player_fk_idx` (`player_fk`),
  KEY `team_fk_idx` (`team_fk`),
  CONSTRAINT `player_idfk` FOREIGN KEY (`player_fk`) REFERENCES `user` (`id`),
  CONSTRAINT `team_idfk` FOREIGN KEY (`team_fk`) REFERENCES `team` (`id`)
...
-- Dump completed on 2022-05-01 23:28:26
